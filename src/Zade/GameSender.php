...
class GameSender extends PluginTask {
	...
	{
		$config = new puntos($this->plugin->getDataFolder() . "/config.yml", Config::YAML);
                $slots = new puntos($this->plugin->getDataFolder() . "/slots.yml", Config::YAML);
					...
					else
					{
						...
						if($config->get($arena . "start")==1)
						{
							...
							else
							{
								...
								if($time == 469)
								{
                                                                    $laimit = new puntos($this->plugin->getDataFolder() . "/limit.yml", Config::YAML);
									foreach($playersArena as $pl)
									{
										...
										foreach($playersArena as $pl)
										{
											$pl->sendMessage($this->prefix .TE::YELLOW. $time2 . " " .TE::GREEN. "seconds left...");
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    {
                                                                        $points = new puntos($this->plugin->getDataFolder() . "/config".$arena.".yml", Config::YAML);
                                                                        foreach ($playersArena as $pl)
                                                                        {
                                                                    ...
                                                                    {
                                                                        $points = new puntos($this->plugin->getDataFolder() . "/config".$arena.".yml", Config::YAML);
                                                                        $limit = new puntos($this->plugin->getDataFolder() . "/limit.yml", Config::YAML);
